...
def main(): 
	...
	print("Mean of accurate Gini using unprocessed data: {:.2f} (+/-: {:.2f})"
		.format(acc_scores_gini_un.mean(),acc_scores_gini_un.std()),end="\n\n" )
				
	print("Mean of F1 score Gini using unprocessed data: {:.2f} (+/-: {:.2f})"
		.format(f1_scores_gini_un.mean(),f1_scores_gini_un.std()),end="\n\n" )
	...
	print("Mean of accurate Entropy using unprocessed data: {:.2f} (+/-: {:.2f})"
		.format(acc_scores_entropy_un.mean(),acc_scores_entropy_un.std()),end="\n\n" )
				
	print("Mean of F1 score Entropy using unprocessed data: {:.2f} (+/-: {:.2f})"
		.format(f1_scores_entropy_un.mean(),f1_scores_entropy_un.std()),end="\n\n" )
